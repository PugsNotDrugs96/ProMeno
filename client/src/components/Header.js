    ...
    return (
        <div className="container">
            <header className="d-flex flex-wrap align-items-center justify-content-between py-3 mb-1 border-bottom">
                <a href="/" className="d-flex align-items-center col-md-3 mb-2 text-dark text-decoration-none">
                    <svg xmlnsXlink="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-heart-pulse-fill" viewBox="0 0 16 16">
